...
CREATE INDEX IF NOT EXISTS navidrome_connections_owner_idx
  ON navidrome_connections (owner_user_id);
...
ALTER TABLE navidrome_connections DROP CONSTRAINT IF EXISTS navidrome_connections_url_username_key;
ALTER TABLE navidrome_connections
