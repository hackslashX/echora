...
type Preview = { tracks: Track[]; references: { positive: Reference[]; negative: Reference[] }; corpus_size: number; weights?: { semantic: number; lyrics: number }; familiarity?: Familiarity; language?: LanguageReport | null };
...
type RevisionRecipe = { references?: { positive: Reference[]; negative: Reference[] }; weights?: { semantic: number; lyrics: number }; familiarity?: Familiarity; target_language?: string; language_strictness?: "only" | "primarily" | "sprinkle" };
