...
import { AudioLines, Clock3, Radio, Server, ShieldCheck, SlidersHorizontal, UserRound } from "lucide-react";
...
type Tab = "server" | "lastfm" | "playback" | "appearance" | "timezone" | "account" | "oidc";
type Settings = {
