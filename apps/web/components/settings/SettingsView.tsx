...
import { Clock3, Radio, Server, ShieldCheck, UserRound } from "lucide-react";
...
type Tab = "server" | "lastfm" | "timezone" | "account" | "oidc";
type Settings = {
