...
import { AudioLines, Clock3, Gauge, MicVocal, Radio, Server, ShieldCheck, SlidersHorizontal, UserRound } from "lucide-react";
...
type Settings = {
  ...
  models: { karaoke_processing_enabled: boolean };
};
